...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!rhData) { alert("Link inválido."); return; }
    ...
    // Define o email no modal (oculto por enquanto)
    document.getElementById('modal-email-rh').innerText = rhData.email_rh || "rh@metanoiaengenharia.com.br";
